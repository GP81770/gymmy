  ...
  return (
    <div className="p-4 rounded-md flex flex-col gap-4 bg-slate-950 sm:flex-wrap ">
      ...
      <div className="flex flex-col">
        <h3 className="text-yellow-500 text-sm">Muscle Groups</h3>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 sm:place-items-center gap-2">
        {["reps", "rest", "tempo"].map((info) => {
          return (
            ...
            >
              <h3 className="capitalize text-lime-600 text-sm">
      ...
      <button
        ...
        className="flex flex-col p-2 rounded border-[1.5px] duration-200 border-solid border-amber-900 hover:border-amber-600 hover:w-full hover:duration-200"
      >
